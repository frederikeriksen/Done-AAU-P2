...
public class DeleteListPickerFragment extends android.support.v4.app.DialogFragment {
    ...
    public Dialog onCreateDialog (Bundle savedInstance) {
        ...
        return new AlertDialog.Builder(getActivity())               // this class provides a fluent interface for constructing
                .setView(v)                                         // an object of Alert Dialog (pop-up)
                .setTitle(R.string.list_delete_picker_title)
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener()
                    {@Override public void onClick(DialogInterface dialog, int which) {sendResult(Activity.RESULT_OK, listId);}})
                .setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener()
                    {@Override public void onClick(DialogInterface dialog, int which) {sendResult(Activity.RESULT_CANCELED, listId);}})
                .create();
    }
