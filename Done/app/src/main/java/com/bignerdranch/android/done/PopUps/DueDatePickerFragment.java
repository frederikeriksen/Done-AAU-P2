...
/**
 * Created by michalisgratsias on 13/04/16.
 */
public class DueDatePickerFragment extends DialogFragment {
    ...
    public static DueDatePickerFragment newInstance(Date date) {       // method to set fragment arguments
    ...
    public Dialog onCreateDialog (Bundle savedInstance) {
        ...
        return new AlertDialog.Builder(getActivity())          // this class provides a fluent interface for constructing
             .setView(v)
             .setTitle(R.string.due_date_picker_title)      // an object of Alert Dialog
